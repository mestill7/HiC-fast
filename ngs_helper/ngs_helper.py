...
def check_readlength(suffix, input_fileset, R1_file_ending, myfastqpath):
    ...
    Input Parameter: 
    suffix (string): ".gz"; Gzipped fastq files are expected to end 
    with the suffix ".gz".
    ...
    Returns:
    list: List containing one integer. 
    The integer is the read length
    """
